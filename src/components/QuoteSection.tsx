  ...
  return (
    <section className="bg-black relative px-4 md:px-6 py-20 md:py-32 font-sans overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto prisma-quote">
        ...
        <div className="mt-20 md:mt-32 relative overflow-hidden flex flex-col items-center w-full">
          <p className="text-xs tracking-[0.25em] font-bold bg-gradient-to-r from-[#00c8ff] via-[#004bff] to-[#00c8ff] bg-clip-text text-transparent mb-8 uppercase text-center">TOOLS THAT POWER US</p>
          <div className="w-full text-[#E1E0CC]/70 hover:text-[#00c8ff] active:text-[#00c8ff] focus-within:text-[#00c8ff] transition-colors duration-300">
            <LogoLoop
              logos={techLogos}
              speed={40}
              direction="left"
