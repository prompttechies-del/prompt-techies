    ...
    <footer className="relative overflow-hidden bg-black w-full min-h-[650px] flex flex-col justify-between pt-24 pb-12 px-6 md:px-12">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col gap-20">
        ...
        <div className="text-center flex flex-col items-center max-w-3xl mx-auto">
          ...
          {/* Description */}
          <p className="text-max-w-2xl text-white/70 text-sm md:text-base leading-relaxed mb-8 mx-auto">
            Prompt Techies builds intelligent technology that transforms ideas into scalable digital products. We engineer AI-powered solutions that accelerate innovation across industries.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pt-8 border-t border-white/[0.04]">
          ...
          <div className="flex flex-col gap-6 text-left">
            ...
            <p className="text-xs text-white/50 leading-relaxed max-w-xs">
              Building the AI Infrastructure of Tomorrow. Engineering intelligent technology that empowers businesses, developers, and enterprises.
            </p>
          ...
          <div className="flex flex-col gap-3 text-left">
            ...
            <a 
              ...
              className="mt-2 px-5 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all whitespace-nowrap bg-gradient-to-r from-[#00c8ff] to-[#004bff] text-white hover:scale-105 shadow-[0_0_15px_rgba(0,200,255,0.3)] w-fit flex items-center gap-2"
            >
              Try Prompt OS
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto mt-16">
        <div className="liquid-glass rounded-full px-6 md:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 w-full backdrop-blur-md">
          ...
          <div className="text-xs text-white/50 select-none">
            © 2026 Prompt Techies (TROVO FI PRIVATE LIMITED). All Rights Reserved.
          </div>
